    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (request.getParameter("token") != null 
            	...
            	out.println("{\"result\": \"positive\", \"name\": \"Matteo\", \"surname\": \"Bianchi\", "
            			+ "\"studentID\": \"140000\", \"studentClass\": \"primo anno\", \"taxes\": \"situazione regolare\", "
            			+ "\"careerPlan\": \"modificabile\", \"availableExams\": 2, \"enrolledExams\": 0, "
            			+ "\"course\": \"INFORMATICA\", \"department\": \"Bioscienze e territorio\", "
            			+ "\"coursePath\": \"COMUNE\", \"courseLength\": 3, \"registrationDate\": \"13/09/2010\"}");
            } else {
