...
public class EnrollExamStub extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            /*
            Controlli momentanei e abbastanza inutili
            */
            if(enrollID.equals(reqEnrollId)
                    && token != null
                    && token.equals(realToken)
                    && username != null
                    && password != null
                    ){
                out.println("{\"result\": \"positive\", \"msg\": \"Prenotazione effettuata con successo!\"}");
            } else {
