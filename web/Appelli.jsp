...
<body>
	...
	<div id="after-loading" style="height: 100%; margin: 0; display: none">
		...
		<myunimol-ajax auto id='ajax' method='POST'
			url="GetExamSessionsServlet" params='{}' handleAs='json'>
		</myunimol-ajax>

		<myunimol-ajax id='ajaxEnrolled' method='POST'
			url="GetEnrolledExamsServlet" params='{}' handleAs='json'>
		</myunimol-ajax>
 ...
 %>
		...
		<core-header-panel main> <core-toolbar
			...
			Appelli </span> </core-toolbar> <paper-tabs selected='0'> <paper-tab
			id='available'>Disponibili</paper-tab> <paper-tab id='enrolled'>Prenotati</paper-tab>
		</paper-tabs>
		<div id='activeContentHandler' class="content">
			...
			<div id='enrolledContent' style="display: none;">
				...
				<div class="centeredMessage" class='no-sessions' id="no-sessions-en"
					style="display: none;">
					<img src="img/swag.png" alt="swag emoji" />
		...
		document
				.addEventListener(
						...
						function() {
							...
							var ajaxEnrolled = document
									.getElementById("ajaxEnrolled");
							var tabAvailable = document
									.getElementById("available");
							var tabEnrolled = document
							...
							tabAvailable
									.addEventListener(
											...
											function() {
												document
														.getElementById("enrolledContent").style.display = 'none';
												document
														.getElementById("availableContent").style.display = 'block';
							...
							tabEnrolled
									.addEventListener(
											...
											function() {
												document
														.getElementById("availableContent").style.display = 'none';
												document
														.getElementById("enrolledContent").style.display = 'block';
									...
									.addEventListener(
											...
											function(event) {
												if (event.detail.response.exams.length == 0) {
													...
													document
															.getElementById("gwsession").sessions = event.detail.response.exams;
												}
											});
							...
							ajaxEnrolled
									.addEventListener(
											...
											function(event) {
												if (event.detail.response.exams.length == 0) {
													document
															.getElementById("no-sessions-en").style.display = "block";
												} else {
													document
															.getElementById("no-sessions-en").style.display = "none";
													document
															.getElementById("ssenrolled").sessions = event.detail.response.exams;
												}
											})
						});
	</script>
